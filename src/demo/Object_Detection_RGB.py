...
config={'streams': ['previewout', 'metaout'],
        'ai': {"blob_file":        str(Path('../models/mobilenet-ssd-custom/mobilenet-ssd_custom.blob').resolve().absolute()),
               "blob_file_config": str(Path('../models/mobilenet-ssd-custom/mobilenet-ssd_custom.json').resolve().absolute())},
        }
