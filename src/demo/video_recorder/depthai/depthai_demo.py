...
class DepthAI:
    ...
    def startLoop(self):
        ...
        # video_file_left = open("video_left.h264", "wb")
        # video_file_right = open("video_right.h264", "wb")
        ...
        while self.runThread:
            ...
            for packet in self.data_packets:
                ...
                if packetData is None:
                    ...
                    # if packet.stream_name == "rectified_left":
                    #     frame_bgr.tofile(video_file_left)
                    # elif packet.stream_name == "rectified_right":
                    #     frame_bgr.tofile(video_file_right)
        ...
        if video_file is not None:
            video_file.close()
        # if video_file_left is not None:
        #     video_file_left.close()
        # if video_file_right is not None:
        #     video_file_right.close()
